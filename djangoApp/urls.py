...
urlpatterns = [
    ...
    path('admin/report',loginviews.report_page,name="report"),
    path('admin/report1',loginviews.report_page1,name="report1"),
    path('admin/Questionbank',loginviews.Que_bank,name="Questionbank"),
    path('admin/structure',loginviews.structure,name="structure"),
    path('admin/structure1',loginviews.structure1,name="structure1"),
    path('admin/category',loginviews.category,name="category"),
    path('admin/subcategory',loginviews.subcategory,name="subcategory"),
    path('admin/viewdata',loginviews.view_data,name="viewdata"),
    path('admin/viewsublist',loginviews.view_sublist,name="viewsubdata"),
    path('admin/manage',loginviews.manage,name="manage"),
